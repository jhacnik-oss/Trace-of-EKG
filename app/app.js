...
function App() {
  ...
  }, /*#__PURE__*/React.createElement("span", null, "Educational and informational content only; not medical advice, diagnosis, or treatment."), /*#__PURE__*/React.createElement("span", null, "Use of this site does not create a clinician-patient relationship and should not replace or delay care from a qualified health professional; for emergencies, call 911 or seek immediate care."), /*#__PURE__*/React.createElement("span", null, "All Trace of EKG content is my intellectual property and may not be reused, reproduced, distributed, or used to train AI systems without my explicit written consent."), /*#__PURE__*/React.createElement("span", null, "EKG images and examples are included for teaching and commentary under fair-use principles; if you are the original rights holder and would like content removed, please reach out.")), /*#__PURE__*/React.createElement("div", null, "\xA9 2026 \xB7 HACNIK"), /*#__PURE__*/React.createElement("button", {
