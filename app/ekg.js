...
function buildBeat(arch, rng) {
  ...
  // Q
  x += 1.5;
  pts.push([x, a.qDepth + j(0.3)]);
  // R (spike up). Wide QRS for mimics/pacing.
  const qrsW = a.wideQRS || a.paced ? 4 : 2;
  x += qrsW;
  pts.push([x, -a.rHeight + j(1)]);
  // S
  x += qrsW;
  pts.push([x, a.sDepth + j(0.5)]);
  x += 1;
  pts.push([x, 0 - a.stElev + j(0.2)]);
  // ST segment
  x += 4 + j(0.5);
  pts.push([x, 0 - a.stElev]);
  // T wave (bump). Peaked for electrolytes (narrow).
  const tW = 4 * a.tWidth;
  x += tW;
  pts.push([x, -a.tHeight + j(0.6)]);
  x += tW;
  pts.push([x, 0]);
  // TP baseline
  x += 10 + j(1);
...
function EKGTrace({
  ...
  return /*#__PURE__*/React.createElement("svg", {
  ...
  }, grid && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("defs", null, /*#__PURE__*/React.createElement("pattern", {
    id: gridId + '-sm',
    width: "2",
    height: "2",
    ...
    d: "M10 0H0V10",
    fill: "none",
    stroke: "rgba(200,53,77,0.32)",
    strokeWidth: "0.25"
  }))), /*#__PURE__*/React.createElement("rect", {
    width: vbW,
    height: vbH,
    fill: `url(#${gridId})`
  })), highlight && /*#__PURE__*/React.createElement("rect", {
    x: highlight.x,
    y: highlight.y,
    width: highlight.w,
    height: highlight.h,
    fill: "rgba(255,235,120,0.18)",
    stroke: "rgba(255,210,60,0.6)",
    strokeWidth: "0.3",
    rx: "1"
  }), /*#__PURE__*/React.createElement("g", {
    transform: animate ? `translate(${-offset},0)` : ''
  }, /*#__PURE__*/React.createElement("path", {
    d: d,
    fill: "none",
    stroke: color,
